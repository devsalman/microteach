        ...
        <div class="widget">
            <div class="navbar">
                <div class="navbar-inner">
                    <h6>{{ Lang::get('title.village_list') }}</h6>
                ...
                <table class="table table-bordered table-striped" id="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ Lang::get('title.village_name') }}</th>
                            <th>{{ Lang::get('title.district_name') }}</th>
                            <th>{{ Lang::get('title.city_name') }}</th>
